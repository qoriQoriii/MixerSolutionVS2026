	...
	public:
		MyForm(void)
		{
			...
			*/
			...
			listaBebidas = InventarioController::GetAllBebidas();
			listaInsumo = InventarioController::GetAllInsumos();
			listaVentas = VentaController::GetAllVentas();
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		try
		{
			...
			*/
			...
			Usuario^ u = UsuarioController::ReadUsuario(user);
			...
			if (u != nullptr )
			{
				...
				if (password == u->Contrasena) {
					...
					String^ tipoUsuario = u->TipoUsuario;
